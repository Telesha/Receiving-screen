...
async function GetCustomerWelfare(searchParamList, fromDate, toDate) {
  ...
  let response = await CommonPost('/api/CustomerWelfare/GetCustomerWelfareDetails', null, searchModel);
  return response;
}
