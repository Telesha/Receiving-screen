...
const screenCode = 'CUSTOMERWELFARE';

export default function CustomerWelfare(probs) {

    const classes = useStyles();
    const alert = useAlert();
    const navigate = useNavigate();
    const [title, setTitle] = useState("Customer Welfare")
    ...
    async function getPermissions() {
        ...
        var isAuthorized = permissions.find(p => p.permissionCode == 'VIEWCUSTOMERWELFARE');
    ...
    async function GetCustomerWelfare() {
        var result = await services.GetCustomerWelfare(searchParamList, moment(fromDate).format(), moment(toDate).format());
            ...
            <Page className={classes.root} title={title}>
                <Container maxWidth={false}>
                    <Formik
                        ...
                        enableReinitialize
                        onSubmit={() => trackPromise(GetCustomerWelfare())}
                    >
                        {({
                            errors,
                            handleBlur,
