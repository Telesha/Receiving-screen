...
async function GetDailyWorkReportDetails(model) {
    const response = await CommonPost('/api/DailyWorkReport/GetDailyWorkReportDetails', null, model);
    return response;
