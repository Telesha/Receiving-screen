...
{/* 
                                    ...
                                    <Grid style={{ justifyContent: "center", paddingLeft: 200 }}>
                                        ...
                                        <Grid container spacing={1}>
                                            ...
                                            <Grid item md={1} xs={12}>
                                                <Typography variant='h5' style={{ marginLeft: "4rem", fontWeight: "bold" }} align="left">Earnings</Typography>
                                            </Grid>

                                            {/* Second Column */}
                                            <Grid item md={3} xs={12}>
                                                <Typography variant='h5' style={{ marginLeft: "10rem" }} align="left">Basic Salary</Typography>
                                            </Grid>
                                            ...
                                            <Grid item md={4} xs={12}>
                                                <Grid container spacing={1}>
                                                    <Grid item md={9} xs={12}>
                                                        {/* <Typography style={{ marginLeft: "15rem" }} align="left">Earnings A</Typography> */}
                                                        {/* <Typography style={{marginLeft: "15rem", backgroundColor: "#e6ffe6" }}
                                                            align="right">
                                                            {index === "0" ? "86000.00" : index === "1" ? "80000.00" : index === "2" ? "75000.00" : index === "3" ? "68000.00" : "90000.00"}
                                                        </Typography> */}
                                                        <Typography variant='h5' style={{ marginLeft: "10rem" }} align="left">{""}</Typography>
                                                    <Grid Grid container spacing={1}>
                                                        <Grid item md={9} xs={12} ><Typography style={{ marginLeft: "15rem" }} align="left">{""}</Typography></Grid>
                                                        <Grid item md={3} xs={12} ><Typography style={{ backgroundColor: "#e6ffe6" }} align="right">{"45000.00"}</Typography></Grid>
                                                    </Grid>
                                        ...
                                        <Grid container spacing={1}>
                                            ...
                                            {/* Second Column */}
                                            <Grid item md={3} xs={12}>
                                                <Typography variant='h5' style={{ marginLeft: "10rem" }} align="left">Basic Salary Adjus</Typography>
                                            </Grid>
                                            ...
                                            <Grid item md={4} xs={12}>
                                                <Grid container spacing={1}>
                                                    ...
                                                    <Grid Grid container spacing={1}>
                                                        <Grid item md={9} xs={12} ><Typography style={{ marginLeft: "15rem" }} align="left">{""}</Typography></Grid>
                                                        <Grid item md={3} xs={12} ><Typography style={{ backgroundColor: "#e6ffe6" }} align="right">{"0.00"}</Typography></Grid>
                                                        </Grid>
                                        ...
                                        <Grid container spacing={1}>
                                            ...
                                            {/* Second Column */}
                                            <Grid item md={3} xs={12}>
                                                <Typography variant='h5' style={{ marginLeft: "10rem" }} align="left">Travelling Allowance</Typography>
                                            </Grid>
                                            ...
                                            <Grid item md={4} xs={12}>
                                                <Grid container spacing={1}>
                                                    ...
                                                    <Grid Grid container spacing={1}>
                                                        <Grid item md={9} xs={12} ><Typography style={{ marginLeft: "15rem" }} align="left">{""}</Typography></Grid>
                                                        <Grid item md={3} xs={12} ><Typography style={{ backgroundColor: "#e6ffe6" }} align="right">{"5000.00"}</Typography></Grid>
                                                    </Grid>
                                        ...
                                        <Grid container spacing={1}>
                                            ...
                                            {/* Second Column */}
                                            <Grid item md={3} xs={12}>
                                                <Typography variant='h5' style={{ marginLeft: "10rem" }} align="left">Increments</Typography>
                                            </Grid>
                                        ...
                                        <Grid container spacing={1}>
                                            ...
                                            {/* Second Column */}
                                            <Grid item md={3} xs={12}>
                                                <Typography variant='h5' style={{ marginLeft: "10rem" }} align="left">Bonus</Typography>
                                            </Grid>
                                ...
                                <Grid container spacing={1}>
                                            ...
                                            {/* Second Column */}
                                            <Grid item md={3} xs={12}>
                                                <Typography variant='h5' style={{ marginLeft: "10rem" }} align="left">Day OT   (Rs500)</Typography>
                                            </Grid>
                                            ...
                                            <Grid item md={4} xs={12}>
                                                <Grid container spacing={1}>
                                                    ...
                                                    <Grid Grid container spacing={1}>
                                                        <Grid item md={9} xs={12} ><Typography style={{ marginLeft: "15rem" }} align="left">{""}</Typography></Grid>
                                                        <Grid item md={3} xs={12} ><Typography style={{ backgroundColor: "#e6ffe6" }} align="right">{"2500.00"}</Typography></Grid>
                                                    </Grid>
                                ...
                                <Grid container spacing={1}>
                                            ...
                                            {/* Second Column */}
                                            <Grid item md={3} xs={12}>
                                                <Typography variant='h5' style={{ marginLeft: "10rem" }} align="left">Night OT      (Rs1000)</Typography>
                                            </Grid>
                                            ...
                                            <Grid item md={4} xs={12}>
                                                <Grid container spacing={1}>
                                                    ...
                                                    <Grid Grid container spacing={1}>
                                                        <Grid item md={9} xs={12} ><Typography style={{ marginLeft: "15rem" }} align="left">{""}</Typography></Grid>
                                                        <Grid item md={3} xs={12} ><Typography style={{ backgroundColor: "#e6ffe6" }} align="right">{"2000.00"}</Typography></Grid>
                                                    </Grid>
                                ...
                                <Grid container spacing={1}>
                                            ...
                                            {/* Second Column */}
                                            <Grid item md={3} xs={12}>
                                                <Typography variant='h5' style={{ marginLeft: "10rem" }} align="left">Double OT (Rs1600)</Typography>
                                            </Grid>
                                            ...
                                            <Grid item md={4} xs={12}>
                                                <Grid container spacing={1}>
                                                    ...
                                                    <Grid Grid container spacing={1}>
                                                        <Grid item md={9} xs={12} ><Typography style={{ marginLeft: "15rem" }} align="left">{""}</Typography></Grid>
                                                        <Grid item md={3} xs={12} ><Typography style={{ backgroundColor: "#e6ffe6" }} align="right">{"3200.00"}</Typography></Grid>
                                                    </Grid>
                                ...
                                <Grid container spacing={1}>
                                            ...
                                            {/* Second Column */}
                                            <Grid item md={3} xs={12}>
                                                <Typography variant='h5' style={{ marginLeft: "10rem" }} align="left">Total Earnings</Typography>
                                            </Grid>
                                            ...
                                            <Grid item md={4} xs={12}>
                                                <Grid container spacing={1}>
                                                    ...
                                                    <Grid Grid container spacing={1}>
                                                        <Grid item md={9} xs={12} ><Typography style={{ marginLeft: "15rem" }} align="left">{""}</Typography></Grid>
                                                        <Grid item md={3} xs={12} ><Typography style={{ backgroundColor: "#e6ffe6" }} align="right">{"57700.00"}</Typography></Grid>
                                                    </Grid>
                                ...
                                <br></br>
                                 ...
                                 {/*<Grid container spacing={1}>
                                            First Column 
                                            <Grid item md={3} xs={12}>
                                                <Typography variant='h5' style={{ marginLeft: "4rem", fontWeight: "bold" }} align="left">Salary Deduction</Typography>
                                            </Grid>

                                             Second Column 
                                            <Grid item md={3} xs={12}>
                                                <Typography variant='h5' style={{ marginLeft: "-4.7rem" }} align="left">Stamp Fees</Typography>
                                            </Grid>
                                            ...
                                            <Grid item md={4} xs={12}>
                                                <Grid container spacing={1}>
                                                    <Grid item md={9} xs={12}>
                                                        <Typography variant='h5' style={{ marginLeft: "10rem" }} align="left">{""}</Typography>
                                                    <Grid Grid container spacing={1}>
                                                        {/* <Grid item md={9} xs={12} ><Typography style={{ marginLeft: "3.1rem" }} align="left">{""}</Typography></Grid> 
                                                         <Grid item md={3} xs={12} style={{ marginLeft: "1.9rem"}} ><Typography style={{ backgroundColor: "#e6ffe6" }} align="right">{"25.00"}</Typography></Grid>
                                                    </Grid>
                                            ...
                                            <Grid item md={4} xs={12}>
                                                <Grid container spacing={1}>
                                                    <Grid item md={9} xs={12}>
                                                        <Typography variant='h5' style={{ marginLeft: "10rem" }} align="left">{""}</Typography>
                                                    <Grid Grid container spacing={1}>
                                                        {/* <Grid item md={3} xs={12} ><Typography style={{ marginLeft: "3.1rem" }} align="right">{""}</Typography></Grid> */}
                                                        <Grid item md={3} xs={12} style={{ marginLeft: "1.9rem"}} ><Typography style={{ backgroundColor: "#e6ffe6" }} align="right"></Typography></Grid>
                                                    </Grid>
                                ...
                                <Grid container spacing={1}>
                                            ...
                                            {/* Second Column */}
                                            <Grid item md={3} xs={12}>
                                                <Typography variant='h5' style={{ marginLeft: "10rem" }} align="left">ADV.PER.INCOME TAX</Typography>
                                            </Grid>
                                ...
                                <Grid container spacing={1}>
                                            ...
                                            {/* Second Column */}
                                            <Grid item md={3} xs={12}>
                                                <Typography variant='h5' style={{ marginLeft: "10rem" }} align="left">EPF Employee</Typography>
                                            </Grid>
                                            ...
                                            <Grid item md={4} xs={12}>
                                                <Grid container spacing={1}>
                                                    ...
                                                    <Grid Grid container spacing={1}>
                                                        <Grid item md={9} xs={12} ><Typography style={{ marginLeft: "15rem" }} align="left">{""}</Typography></Grid>
                                                        <Grid item md={3} xs={12} ><Typography style={{ backgroundColor: "#e6ffe6" }} align="right">{"3600.00"}</Typography></Grid>
                                                    </Grid>
                                ...
                                <Grid container spacing={1}>
                                            ...
                                            {/* Second Column */}
                                            <Grid item md={3} xs={12}>
                                                <Typography variant='h5' style={{ marginLeft: "10rem" }} align="left">Total Deduction</Typography>
                                            </Grid>
                                            ...
                                            <Grid item md={4} xs={12}>
                                                <Grid container spacing={1}>
                                                    ...
                                                    <Grid Grid container spacing={1}>
                                                        <Grid item md={9} xs={12} ><Typography style={{ marginLeft: "15rem" }} align="left">{""}</Typography></Grid>
                                                        <Grid item md={3} xs={12} ><Typography style={{ backgroundColor: "#e6ffe6" }} align="right">{"3625.00"}</Typography></Grid>
                                                    </Grid>
                                ...
                                <Grid container spacing={1}>
                                            ...
                                            {/* Second Column */}
                                            <Grid item md={3} xs={12}>
                                                <Typography variant='h5' style={{ marginLeft: "10rem" }} align="left">Net Salary (Total Pay)</Typography>
                                            </Grid>
                                            ...
                                            <Grid item md={4} xs={12}>
                                                <Grid container spacing={1}>
                                                    ...
                                                    <Grid Grid container spacing={1}>
                                                        <Grid item md={9} xs={12} ><Typography style={{ marginLeft: "15rem" }} align="left">{""}</Typography></Grid>
                                                        <Grid item md={3} xs={12} ><Typography style={{ backgroundColor: "#e6ffe6" }} align="right">{"54075.00"}</Typography></Grid>
                                                    </Grid>
                                ...
                                <div style={{ paddingRight: 200 }}>
                                        ...
                                        <br></br>
                                         ...
                                         <Grid container spacing={1}>
                                            {/* First Column */}
                                            <Grid item md={3} xs={12}>
                                                <Typography variant='h5' style={{ marginLeft: "4rem", fontWeight: "bold" }} align="left">COMP. Contribution</Typography>
                                            </Grid>
                                        ...
                                        {/*<Grid container spacing={1}>
                                            ...
                                            Second Column 
                                            <Grid item md={3} xs={12}>
                                                <Typography variant='h5' style={{ marginLeft: "10rem" }} align="left">EPF-EMPLOYER</Typography>
                                            </Grid>
                                            ...
                                            <Grid item md={4} xs={12}>
                                                <Grid container spacing={1}>
                                                    ...
                                                    <Grid Grid container spacing={1}>
                                                         <Grid item md={3} xs={12} ><Typography style={{ marginLeft: "3.1rem" }} align="right">{""}</Typography></Grid> 
                                                        <Grid item md={3} xs={12} style={{ marginLeft: "1.9rem"}} ><Typography style={{ backgroundColor: "#e6ffe6" }} align="right">{"5400.00"}</Typography></Grid>
                                                    </Grid>
                                        ...
                                        <Grid container spacing={1}>
                                            ...
                                            <Grid item md={4} xs={12}>
                                                <Grid container spacing={1}>
                                                    ...
                                                    <Grid Grid container spacing={1}>
                                                        <Grid item md={9} xs={12} ><Typography style={{ marginLeft: "15rem" }} align="left">{""}</Typography></Grid>
                                                        <Grid item md={3} xs={12} ><Typography style={{ backgroundColor: "#e6ffe6" }} align="right">{"5400.00"}</Typography></Grid>
                                                        </Grid>
                                       ...
                                       <Grid container spacing={1}>
                                            ...
                                            <Grid item md={1} xs={12}>
                                             ...
                                             {/* Second Column */} 
                                            <Grid item md={3} xs={12}>
                                                <Typography variant='h5' style={{ marginLeft: "10rem" }} align="left">ETF-EMPLOYER</Typography>
                                            </Grid>
                                            ...
                                            <Grid item md={4} xs={12}>
                                                <Grid container spacing={1}>
                                                    ...
                                                    <Grid Grid container spacing={1}>
                                                        <Grid item md={9} xs={12} ><Typography style={{ marginLeft: "15rem" }} align="left">{""}</Typography></Grid>
                                                        <Grid item md={3} xs={12} ><Typography style={{ backgroundColor: "#e6ffe6" }} align="right">{"1350.00"}</Typography></Grid>
                                                    </Grid>
                                                ...
                                                <Grid container spacing={1} key={index}>
                                                    <Grid item md={7} xs={12}>
                                                        ...
                                                        <Grid Grid container spacing={1}>
                                                            ...
                                                            <Grid Grid container spacing={1}>
                                                                <Grid item md={9} xs={12} ><Typography style={{ marginLeft: "15rem" }} align="left">{""}</Typography></Grid>
                                                                <Grid item md={3} xs={12} ><Typography style={{ backgroundColor: "#e6ffe6" }} align="right">{additionData.amount}</Typography></Grid>
                                                            </Grid>
                                                        </Grid>
                                                    </Grid>
                                                </Grid>
                                                ...
                                                <Grid container spacing={1} key={index}>
                                                    <Grid item md={7} xs={12}>
                                                        ...
                                                        <Grid Grid container spacing={1}>
                                                            ...
                                                            <Grid Grid container spacing={1}>
                                                                <Grid item md={9} xs={12} ><Typography style={{ marginLeft: "15rem" }} align="left">{""}</Typography></Grid>
                                                                <Grid item md={3} xs={12} ><Typography style={{ backgroundColor: "#ffcccb" }} align="right">{additionData.amount}</Typography></Grid>
                                                            </Grid>
                                                        </Grid>
                                                    </Grid>
                                                </Grid>
