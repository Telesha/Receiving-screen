...
const screenCode = 'GREENLEAFREPORT';

export default function GreenLeafReport(props) {
  const [title, setTitle] = useState('Cash Kilo Report');
  ...
  const [alertCount, setAlertCount] = useState({
    ...
    const iJobTypes = [
      { jobTypeID: 0, jobTypeName: 'All Jobs' },
      { jobTypeID: 5, jobTypeName: 'Plucking CashKilo' },
      { jobTypeID: 7, jobTypeName: 'MachinePlucking CashKilo' }
    ];
  ...
  async function getPermission() {
    ...
    var isAuthorized = permissions.find(
      p => p.permissionCode == 'VIEWGREENLEAFREPORT'
    );
                    ...
                    <Grid container spacing={4}>
                          ...
                          <Grid item md={4} xs={12}>
                            ...
                            >
                              ...
                              <MenuItem value={'5'}>Plucking CashKilo</MenuItem>
                              <MenuItem value={'7'}>MachinePlucking CashKilo </MenuItem>
                            </TextField>
                          </Grid>
