...
async function GetSlowMovingDebtListDetails(requestModel) {
  let response = await CommonPost('/api/SlowMovingDebtList/GetSlowMovingDebtListDetails', null, requestModel);
  return response;
}
