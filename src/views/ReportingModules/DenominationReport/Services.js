...
async function GetDenominationReportDetails(model) {
  let response = await CommonPost('/api/DenominationReport/GetDenominationReportDetails', null, model);
  return response;
}
