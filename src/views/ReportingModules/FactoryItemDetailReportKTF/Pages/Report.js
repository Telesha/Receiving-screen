...
const screenCode = 'FACTORYITEMDETAILREPORTKTF';

export default function FactoryItemDetailReportKtf(props) {
  const [title, setTitle] = useState("Factory Item Detail Report - KTF");
  ...
  async function getPermission() {
    ...
    var isAuthorized = permissions.find(p => p.permissionCode == 'VIEWFACTORYITEMDETAILREPORTKTF');
  ...
  async function createDataForExcel(array) {
    ...
    if (array != null) {
      ...
      var vr = {
        ...
        'Date': 'Factory - ' + selectedSearchValues.factoryName,
        'Reg No': 'From Date - ' + selectedSearchValues.startDate,
        'Supplier Name': 'To Date - ' + selectedSearchValues.endDate,
      };
      res.push(vr);
    }
    return res;
  ...
  async function createFile() {
    ...
    var settings = {
      sheetName: 'Factory Item Detail Report_KTF',
      fileName: 'Factory Item Detail Report_KTF',
      writeOptions: {}
    }
    ...
    let dataA = [
      {
        sheet: 'Factory Item Detail Report_KTF',
                    ...
                    <PerfectScrollbar>
                      ...
                      {factoryItemList.length > 0 ?
                        <Box display="flex" justifyContent="flex-end" p={2}>
                          ...
                          <ReactToPrint
                            documentTitle={"Factory Item Detail Report - KTF"}
                            trigger={() => <Button
                              color="primary"
                              id="btnRecord"
                              type="submit"
