    ...
    return (
      <div>
        <Paper elevation={0} style={{ width: '100%', height: '100%' }}>
          ...
          <h2><u>Factory Item Details Report - KTF</u></h2>
          <br />
              ...
              <TableBody>
                {factoryItemList.map((data, index) => (
                  <TableRow key={index}>
                    ...
                    <TableCell component="th" scope="row" align="left" style={{ fontSize: '10px', border: "1px solid black", padding: '4px' }}> {data.name}</TableCell>
