...
export default {
  ...
  GetWorkDistributionSummaryReportDetails
};
...
async function GetWorkDistributionSummaryReportDetails(model) {
  let response = await CommonPost('/api/WorkDistributionSummaryReport/GetWorkDistributionSummaryReportDetails', null, model);
  return response;
}