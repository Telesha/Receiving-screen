...
export default function GreenLeafEntryView(props) {
  ...
  async function getAdvancePaymentRequestDetails(greenLeafEntryID) {
    let response = await services.getAdvancePaymentRequestDetails(greenLeafEntryID);
    let data = response[0];
