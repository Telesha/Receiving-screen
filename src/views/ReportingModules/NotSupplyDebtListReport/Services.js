...
async function GetNotSupplyDebtList(notSupplyDebtModel) {
  let response = await CommonPost('/api/NotSupplyDebtList/GetNotSupplyDebtList', null, notSupplyDebtModel);
  return response;
}
