...
export default function DebtorsAgeingConfigurationSetup(props) {
    ...
    const [title, setTitle] = useState("Debtors Ageing Setup");
    const [permissionList, setPermissions] = useState({
        isGroupFilterEnabled: false,
        isFactoryFilterEnabled: false,
    });
    const handleClickNavigate = () => {
        navigate('/app/DebtorsAgeing/DebtorsAgeingReport');
    }
    ...
    useEffect(() => {
        ...
        trackPromise(GetDebtorsAgeingSecctionDetails())
    ...
    async function GetDebtorsAgeingSecctionDetails() {
        const respose = await services.GetDebtorsAgeingSectionDetails(DebtorsAgeingDetails.groupID, DebtorsAgeingDetails.factoryID);
    ...
    async function getPermission() {
        ...
        var isAuthorized = permissions.find(p => p.permissionCode == 'ENABLEDEBTORSAGEINGCONFIGURATION');
    ...
    async function GetDebtorsAgeingSetupConfigurationDetails() {
        const result = await services.GetDebtorsAgeingSectionSetupConfigurationDetails(parseInt(DecryptedGroupID.toString()), parseInt(DecryptedFactoryID.toString()));
        return result;
    }
    ...
    async function SaveDebtorsAgeingSetupDetails() {
        let requestModel = {
        ...
        const response = await services.SaveDebtorsAgeingSetupDetails(requestModel)
            ...
            <Page
                ...
                <Container maxWidth={false}>
                    <Formik
                        ...
                        onSubmit={() => trackPromise(SaveDebtorsAgeingSetupDetails())}
                        enableReinitialize
                    >
                        {({
                            errors,
