...
async function GetDailyForecastDetails(dailyCropForecastModel) {
  let response = await CommonPost('/api/DailyCropDetails/GetDailyForecastDetails', null, dailyCropForecastModel);
  return response;
}
