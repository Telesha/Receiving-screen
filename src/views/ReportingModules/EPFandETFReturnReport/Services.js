...
async function GetEPFandETFReturnDeatails(model) {
  let response = await CommonPost('/api/Statutory/GetStatutoryReturnDetailsForReport', null, model);
  return response;
}
