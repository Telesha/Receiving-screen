...
const screenCode = 'BALANCEPAYMENTLISTREPORT';

export default function BalancePaymentListReport(props) {
  const [title, setTitle] = useState('Balance Payment List Report');
  ...
  async function getPermission() {
    ...
    var isAuthorized = permissions.find(
      p => p.permissionCode == 'VIEWBALANCEPAYMENTLISTREPORT'
    );
