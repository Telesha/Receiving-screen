...
export default class ComponentToPrint extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <h2><center><u>Balance Payment Checklist Report</u></center></h2>
        <div>&nbsp;</div>
        <h2><center>{searchData.groupName} - {searchData.factoryName}</center></h2>
        <div>&nbsp;</div>
        <h3><center> Bought Leaf Balance Payment Checklist the Month of {searchData.monthName} - {searchDate.year}</center></h3>
        <div>&nbsp;</div>
