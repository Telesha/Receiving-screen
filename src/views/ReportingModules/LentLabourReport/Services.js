...
async function getLentLabourDetailsForReport(model) {
  let response = await CommonPost('/api/LentLabourReport/GetLentLabourDetails', null, model);
  return response;
}