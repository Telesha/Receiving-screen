...
async function getSalesDetailsReportData(model) {
    let response = await CommonPost('/api/SalesDetailsReport/GetSalesDetailsReport', null, model);
    return response;
}
