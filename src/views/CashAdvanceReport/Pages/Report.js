...
const screenCode = 'CASHADVANCEREPORT';

export default function CashAdvanceReport(props) {
    const [title, setTitle] = useState("Cash Advance Report")
    ...
    async function getPermission() {
        ...
        var isAuthorized = permissions.find(p => p.permissionCode == 'VIEWCASHADVANCEREPORT');
    ...
    async function GetDetails() {
        ...
        const response = await services.GetCashAdvanceReportDetails(model);
