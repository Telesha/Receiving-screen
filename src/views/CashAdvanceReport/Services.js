...
async function GetCashAdvanceReportDetails(model) {
  const response = await CommonPost('/api/CashAdvanceReport/GetCashAdvanceReportDetails', null, model);
  return response;
