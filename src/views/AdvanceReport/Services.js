...
async function getAdvanceReportDetails(model) {
  const response = await CommonPost('/api/AdvanceReport/GetAdvanceReportDetails', null, model);
  return response;
