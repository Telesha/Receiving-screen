...
export default function FactoryAddEdit() {
  ...
  useEffect(() => {
    ...
    if (decryptedID != 0) {
      setIsUpdate(true);
      setTitle("Update Operation Entity");
                        ...
                        <Grid container spacing={4}>
                          <Grid className={classes.root1} item xs={12}>
                            ...
                            <TabPanel value={value} index={0}>
                              <GeneralDetails generalDetailsArray={generalDetailsArray} setGeneralDetailsArray={setGeneralDetailsArray} isUpdate={isUpdate} checkAllTabFill={checkAllTabFill} />
                            </TabPanel>
                            <TabPanel value={value} index={1}>
                              <ContactInformation oldData={oldData} setOldData={setOldData} checkAllTabFill={checkAllTabFill} />
                            </TabPanel>
                            <TabPanel value={value} index={2}>
                              <FactoryAccounts factoryAccountArray={factoryAccountArray} setFactoryAccountArray={setFactoryAccountArray} setChecker1={setChecker1} checker1={checker1} checkAllTabFill={checkAllTabFill} />
                            </TabPanel>
                            <TabPanel value={value} index={3}>
                              <Productdetails productDetailsArray={productDetailsArray} setProductDetailsArray={setProductDetailsArray} setChecker={setChecker} checker={checker} checkAllTabFill={checkAllTabFill} />
                            </TabPanel>
