...
export default {
  ...
  GetDailyAdvanceAndFactoryItemDetailsForReport,
...
async function GetDailyAdvanceAndFactoryItemDetailsForReport(dailyAdvanceAndFactoryItemDetailRequestModel) {
  let response = await CommonPost('/api/DailyAdvanceAndFactoryItem/GetDailyAdvanceAndFactoryItemDetailsForReport', null, dailyAdvanceAndFactoryItemDetailRequestModel);
  return response;
}
