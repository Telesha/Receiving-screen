...
export default function LankemPaymentListing() {
  ...
  const handleClick = () => {
    ...
    navigate('/app/LankemPayment/addedit/' + encrypted + "/" + encryptedgroupID + "/" + encryptedfactoryID);
  }
  ...
  const handleClickApprove = (referenceNumber) => {
    ...
    encryptedgroupID = btoa(generalJournalList.groupID.toString());
    encryptedfactoryID = btoa(generalJournalList.factoryID.toString());
    navigate('/app/LankemPayment/approve/' + encrypted + "/" + encryptedgroupID + "/" + encryptedfactoryID);
  }
  ...
  const handleClickView = (referenceNumber) => {
    ...
    encryptedgroupID = btoa(generalJournalList.groupID.toString());
    encryptedfactoryID = btoa(generalJournalList.factoryID.toString());
    navigate('/app/LankemPayment/view/' + encryptedgroupID + "/" + encryptedfactoryID + '/MA==/MA==/MA==/MA==/' + encrypted); //MA== 0 value
  }
  ...
  async function getPermissions() {
    ...
    var isAuthorized = permissions.find(p => p.permissionCode == 'VIEWLANKEMPAYMENT');
                      ...
                      <Box minWidth={1000} >
                        <MaterialTable
                          ...
                          columns={[
                            ...
                            {
                              title: 'Tran. Mode', field: 'modeoftransactionID',
                              lookup: {
                                1: 'Cheque',
                                2: 'Fund Transfer',
                                3: 'Cash',
