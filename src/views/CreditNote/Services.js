...
async function getCreditNoteDetails(requestModel) {
  const response = await CommonPost('/api/CreditNote/GetCreditNoteDetailsList', null, requestModel);
  return response;
}

async function GetAllTransactionAndPreviousCreditNoteDetails(requestModel) {
  const response = await CommonPost('/api/CreditNote/GetAllTransactionAndPreviousDetails', null, requestModel);
  return response;
}

async function GetCreditNoteDetailsForEditProcessByVoucherID(requestModel) {
  const response = await CommonPost('/api/CreditNote/GetCreditNoteDetailsForEditProcessByVoucherID', null, requestModel);
  return response;
}
...
async function SendToApproveCreditNoteDetails(requestModel) {
  const response = await CommonPost('/api/CreditNote/SendToApproveCreditNote', null, requestModel);
  return response;
}

async function ApproveCreditNoteDetails(requestModel) {
  const response = await CommonPost('/api/CreditNote/ApproveCreditNote', null, requestModel);
  return response;
}

async function RejectCreditNoteDetails(requestModel) {
  const response = await CommonPost('/api/CreditNote/RejectCreditNote', null, requestModel);
  return response;
}