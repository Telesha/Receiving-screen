...
const screenCode = 'PAYROLLADVANCEREPORT';

export default function PayrollAdvanceReport(props) {
    const [title, setTitle] = useState("Payroll Advance Report")
    ...
    async function getPermission() {
        ...
        var isAuthorized = permissions.find(p => p.permissionCode == 'VIEWPAYROLLADVANCEREPORT');
    ...
    async function getFactoriesForDropDown() {
        const factories = await services.getFactoriesByGroupID(stockBalanceReportInput.groupID);setDesignation(designation);
    ...
    async function GetDetails() {
        ...
        const response = await services.getPayrollAdvanceReportDetails(model);
    ...
    async function createDataForExcel(array) {
        ...
        if (array != null) {
            ...
            var dataModel = {
                ...
                'Employee Name': 'Division : ' + selectedSearchValues.designationName,
    ...
    async function createFile() {
        ...
        var settings = {
            sheetName: 'Payroll Advance Report',
            fileName: 'Payroll Advance Report ' + ' - ' + selectedSearchValues.groupName + ' - ' + selectedSearchValues.factoryName,
            writeOptions: {}
        }
    ...
    function getSelectedDropdownValuesForReport(searchForm) {
        setSelectedSearchValues({
            ...
            designationName : stockBalanceReportInput.designationID == 0 ? "All" : designation[searchForm.designationID],
                                                        ...
                                                        <TableContainer component={Paper}>
                                                            ...
                                                            >
                                                                ...
                                                                <TableBody>
                                                                    ...
                                                                    <TableRow >
                                                                        <TableCell colSpan={3} style={{ border: "2px solid black", fontWeight: "bold" }} align="left" component="th" scope="row">
                                                                            Total
                                                                        </TableCell>
