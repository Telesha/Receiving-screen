...
export const LoanInitiating = ({
    ...
    async function SubmitLoanRequest() {
        ...
        let object = {
            ...
            paymentEffectiveMonth: PaymentEfectedMonth.toISOString(),
        }
    ...
    function CalculateLoanFullDetails() {
        ...
        if (LoanDetails.noOfInstalments === "" || LoanDetails.noOfInstalments === "" || LoanDetails.loanAmount === "" || LoanDetails.annualInterestsRate === "" || LoanDetails.disbursementType === 0 || LoanDetails.loanType === 0 || PaymentEfectedMonth === null) {
        ...
        let obj = {
            ...
            paymentMonth: PaymentEfectedMonth
        }
    ...
    function EqualMonthlyInstalmentLoanCalculator(obj) {
        ...
        for (let index = 0; index < N; index++) {
            ...
            let month = moment(date).format("YYYY-MMMM")
    ...
    return (
        <Formik
            initialValues={{
                ...
                paymetEffectedMonth: PaymentEfectedMonth
            }}
            validationSchema={
                Yup.object().shape({
                    ...
                    paymetEffectedMonth: Yup.date().required('Payment Effective Month is required')
                })
            }
            enableReinitialize
                            ...
                            <Card style={{ maxHeight: '33rem', minHeight: '33rem' }}>
                                ...
                                <CardContent>
                                    ...
                                    <TextField select
                                        ...
                                        id="disbursementType"
                                        InputProps={{
                                            readOnly: LoanDetails.loanType == 5
                                        }}
                                    >
